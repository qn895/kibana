...
```
npx tsx x-pack/platform/plugins/shared/inference/scripts/load_esql_docs/generate_esql_docs.ts

or

node x-pack/platform/plugins/shared/inference/scripts/generate_esql_docs/index.js
```
