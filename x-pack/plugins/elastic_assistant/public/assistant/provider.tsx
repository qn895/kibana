...
import { useBasePath, useIsExperimentalFeatureEnabled } from '../lib/hooks/services';
import { useKibana } from '../lib/hooks/kibana';
import { useAppToasts } from '../lib/hooks/use_app_toasts';
import { useSignalIndex } from '../lib/hooks/use_signal_index';

const APP_ID = 'ELASTIC_ASSISTANT';
